                                                    	...
                                                    	<tr>
                                                          ...
                                                          <tr>
                                                           ...
                                                           <tr>
                                                                ...
                                                                <div class="form-group edit_field">
                                                                	<label>Website:</label>
                                                                	<input type="text" id="p_Hour_rate" name="p_Hour_rate" class="form-control" value="<?php echo $userdata['Hour_rate']; ?>">
                                                          ...
                                                          <tr>
														   ...
														   <tr>
                                                                ...
                                                                <div class="form-group edit_field">
																	...
																	<textarea id="offer_1345" name="p_offer" class="offerforprofile form-control"><?php //echo $userdata['offer']; ?></textarea>
									...
									?>
									 ...
									 <?php if(isset(Yii::app()->session['userid'])){ ?>
										<div class="check_btn ">
											...
											<input type="hidden" value="upworksanjeev-facilitator@gmail.com" name="business">
						...
						<article class="myreviews" style="border-top: medium none;">
							<h1>Your Orders</a></h1>
								...
								<div class="table-responsive">
									...
									<!--<td><a href="<?php// echo $base_url."/User/EditAdd/".$Adsdetail['id'];?>">Edit</a>  <a style="cursor:pointer;" onclick="return DeleteAdd('<?php// echo $Adsdetail['id'];?>');">Delete</a> </td>-->
								</tr>
