...
<span class="radio"><input name= "how_many_freelancer" required value="One" type="radio"><label>I want to hire one freelancer</label></span>
<span class="radio"><input name= "how_many_freelancer" value="More Then One" type="radio"><label>I want to hire more than one freelancer</label></span>
</div>
<div class="form-group">
<label>Enter Skill needed</label>
<input type="text" required name="skills" placeholder="e.g. HTML, CSS, PHP">
</div>
<div class="form-group">
