 ...
 <div class="container">
	...
	<div>
		<?php if(Yii::app()->user->hasFlash('error')): ?>
			<div class="flash-error alert alert-danger" style="margin-top:30px;">
	...
	<div class="col-xs-12 col-sm-6 formarea">	
		<form id="forgotpassword" action="<?php echo $base_url; ?>/site/ChangePassword" method="post">  
			...
			<input type="password" name="oldpassword" required class="form-control" id="femailid" placeholder="Old Password" value="<?php echo @$_POST['oldpassword'];?>" />
			</div>
			<div class="form-group">
			<label for="exampleInputEmail1">New Password:<sup>*</sup></label>
			<input type="password" name="newpassword" required class="form-control" id="femailid" placeholder="New Password" value="<?php echo @$_POST['newpassword'];?>" />
			</div>
